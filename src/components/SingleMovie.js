...
class SingleMovie extends Component {
    ...
    clickButtonClose = () => {
        document.querySelector('.singleMovie__watchContainer').classList.remove('singleMovie__watchContainer--active')
        const iframe = document.querySelector('.singleMovie__iframe');
        if(iframe) {
    ...
    render(){
        return ( 
            <div className="singleMovie" style={{backgroundImage: `url("https://image.tmdb.org/t/p/original${this.props.backDropPath}")`}}>
                ...
                <div className="singleMovie__container">
                    ...
                    <div className="singleMovie__singleItem singleMovie__singleItem--second">
                ...
                <img src={`https://image.tmdb.org/t/p/original${this.props.posterPath}`} alt="Poster img" className="singleMovie__poster"/>
                ...
                <div className="singleMovie__watchContainer">
                    <button className="singleMovie__iframeClose fas fa-times" onClick={this.clickButtonClose}></button>
